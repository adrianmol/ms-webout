 ...
 */
final class Version20230202113348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_to_category (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product_to_category_categories (product_to_category_id INT NOT NULL, categories_id INT NOT NULL, INDEX IDX_1D10AD2F6FBCDDAD (product_to_category_id), INDEX IDX_1D10AD2FA21214B7 (categories_id), PRIMARY KEY(product_to_category_id, categories_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
